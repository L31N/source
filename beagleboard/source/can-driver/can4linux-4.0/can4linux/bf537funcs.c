 ...
 *------------------------------------------------------------------
 * $Header: /z2/cvsroot/products/0530/software/can4linux/src/bf537funcs.c,v 1.1 2006/04/21 16:25:55 oe Exp $
 *
 *--------------------------------------------------------------------------
 *
 *
 ...
 * --------------------
 * $Log: bf537funcs.c,v $
 * Revision 1.1  2006/04/21 16:25:55  oe
...
#define pPORT_MUX((volatile unsigned short *)PORT_MUX)
    ...
    */
	...
	/* .id0 is unused with base format frames, but anyway set to 0 */
...
/*  Does BlackFin have such filters ? */
