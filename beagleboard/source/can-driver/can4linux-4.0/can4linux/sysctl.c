...
/* or, if defined at /proc/sys/Can$(CAN_MODULE_POSTFIX) */
...
int TxErrCounter[MAX_CHANNELS]   = { 0x0 };  /* CAN controllers err counter */
int RxErrCounter[MAX_CHANNELS]   = { 0x0 };  /* CAN controllers err counter */
int Overrun[MAX_CHANNELS]        = { 0x0 };  /* number of HW CAN RX overruns */
